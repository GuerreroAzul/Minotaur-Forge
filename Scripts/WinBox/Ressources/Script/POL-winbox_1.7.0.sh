...
if [ ! -d "$HOME/.PlayOnLinux/configurations/setups/$TITLE" ]; then
  mkdir "$HOME/.PlayOnLinux/configurations/setups/$TITLE"
fi

if [ ! -f "$HOME/.PlayOnLinux/configurations/setups/$TITLE/top" ]; then
  wget -O "$HOME/.PlayOnLinux/configurations/setups/$TITLE/top" "$LOGO"
fi

if [ ! -f "$HOME/.PlayOnLinux/configurations/setups/$TITLE/left" ]; then
  wget -O "$HOME/.PlayOnLinux/configurations/setups/$TITLE/left" "$BANNER"
fi
